<div class="table" id="read">
    ...
    <div class="table_body">
        ...
        <div class="table_row">
            ...
            <span class="column_update"><a class="update_btn" href="/?action=update&id=<?= $record["id"]; ?>"><i class="fas fa-edit"></i></a></span>
            <span class="column_delete"><a class="delete_btn" href="/?action=delete&id=<?= $record["id"]; ?>"><i class="fas fa-trash-alt"></i></a></span>
        </div>
        <?php endforeach; ?>
    </div>
